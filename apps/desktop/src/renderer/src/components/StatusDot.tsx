...
const DOT_COLOR: Record<Exclude<WorkspaceStatus, "idle">, string> = {
 ...
 * an inactive workspace looks exactly as it did before; any other status
 * renders a colored dot (pulsing for live states).
 */
