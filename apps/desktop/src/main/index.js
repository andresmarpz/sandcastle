...
function createWindow() {
    ...
    mainWindow.webContents.on("context-menu", (_event, params) => {
        const template = [];
        const { isEditable, editFlags, selectionText, linkURL, misspelledWord, dictionarySuggestions } = params;
        if (misspelledWord) {
        ...
        if (isEditable) {
            template.push({ role: "cut", enabled: editFlags.canCut }, { role: "copy", enabled: editFlags.canCopy }, { role: "paste", enabled: editFlags.canPaste }, { type: "separator" }, { role: "selectAll", enabled: editFlags.canSelectAll });
        }
