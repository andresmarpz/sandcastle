import { ChevronRightIcon, AlertCircleIcon, CheckCircleIcon, BrainIcon, AlertTriangleIcon } from "lucide-react";
import {
  Collapsible,
  CollapsibleTrigger,
  CollapsiblePanel,
...
export function ToolResultBlock({ toolName, output, isError }: ToolResultBlockProps) {
  return (
    <Collapsible className="w-full">
      <CollapsibleTrigger
        className={cn(
