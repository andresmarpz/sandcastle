		...
		<ContextMenuPrimitive.Portal>
			...
			>
				<ContextMenuPrimitive.Popup
					...
					className={cn(
						"ring-foreground/10 bg-popover text-popover-foreground min-w-36 rounded-md p-1 shadow-md ring-1 z-50 max-h-(--available-height) origin-(--transform-origin) overflow-x-hidden overflow-y-auto outline-none",
						className,
					)}
					{...props}
				/>
